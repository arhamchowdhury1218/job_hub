...
onMounted(async () => {
  try {
    ...
    form.companyName = jobData.companyName; // Changed to match API response
    form.companyDescription = jobData.companyDescription; // Changed to match API response
    form.contactEmail = jobData.contactEmail; // Changed to match API response
    form.contactPhone = jobData.contactPhone; // Changed to match API response
  } catch (error) {
